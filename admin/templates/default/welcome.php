  ...
  <div class="info-panel">
    ...
    <dl class="system">
      <dt>
        ...
        <div id="system-info">
          <ul>
            <li>好商城V3-b12 <?php echo $lang['dashboard_welcome_version'];?><span>20151012</span></li>
      ...
      <dd>
        <ul>
          <li class="w50pre none"><a href="http://www.shopnc.club" target="_blank">官方网站<sub></sub></a></li>
          <li class="w50pre none"><a href="http://bbs.shopnc.club" target="_blank">官方论坛<sub></sub></a></li>
        </ul>
      </dd>
    </dl>
    <div class="clear"></div>
