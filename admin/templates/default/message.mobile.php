      ...
      <tbody>
       <tr class="noborder">
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><label class="field_notice"> 	可选填写<a href="http://api.smsbao.com/" target="_blank">短信宝</a>或
          <a href="http://www.yunpian.com/" target="_blank">云片短信</a></label></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="password" value="<?php echo $output['list_setting']['mobile_pwd'];?>" name="mobile_pwd" id="mobile_pwd" class="txt"></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="password" value="<?php echo $output['list_setting']['mobile_key'];?>" name="mobile_key" id="mobile_key" class="txt"></td>
          <td class="vatop tips"><label class="field_notice">可选填写【使用云片短信时用到】</label></td>
        </tr>
