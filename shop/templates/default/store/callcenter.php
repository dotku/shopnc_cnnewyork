...
<div class="ncs-message-bar">
  <div class="default">
    <h5><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" title="进入店铺"><?php echo $output['store_info']['store_name']; ?></a></h5>
