...
<div class="nc-login-layout">
  <div class="openid"><span class="avatar"><img src="<?php echo $output['sinauser_info']['avatar_large'];?>" /></span><span>您使用新浪账号<a href="#register_form"><?php echo $output['sinauser_info']['screen_name']; ?></a>注册成功，系统为您随机新建商城用户名<br/>
  ...
  <div class="nc-login">
    <div class="arrow"></div>
    <div class="nc-sina-mode">
      <ul class="tabs-nav">
        <li><a href="#register"><?php echo $lang['home_sconnect_register_title']; ?><i></i></a></li>
      </ul>
      <div id="tabs_container" class="tabs-container">
        <div id="register" class="tabs-content">
          <form name="register_form" id="register_form" class="nc-login-form" method="post" action="index.php?act=connect_sina&op=register">
